        ...
        return (
            ...
            <div className="content">
                ...
                <div className="productInfor" id="carts"><div className="cart">
                    ...
                    <div className="detailInfor"><span>{this.state.nameProduct}</span></div>
                    <div className="detailInfor">
                        <span className="afterSale">{this.state.afterSale}  đ</span>
                        <span className="beforSale"> {this.state.beforSale} đ</span>
                    </div>
                    <div className="detailInfor">
                        <input type="number" min={1} id="quantityProduct" defaultValue={this.state.quantityProduct} onChange={(event) => {
                            this.setState({ quantityProduct: event.target.valueAsNumber })
                        }} />
                    </div>
                    <div className="detailInfor">
                        <span>{(this.state.quantityProduct || 0) * (this.state.afterSale || 0)}</span>
                    </div>
                    <div className="detailInfor">
